...
enum class ErrorCode(
    ...
    CONFLICT_USER(HttpStatus.CONFLICT, "E301", "이미 존재하는 사용자 입니다."),
    CONFLICT_USER_EMAIL(HttpStatus.CONFLICT, "E302", "이미 존재하는 이메일 입니다."),
    CONFLICT_USER_LOGIN_ID(HttpStatus.CONFLICT, "E303", "이미 존재하는 로그인 아이디 입니다."),
